...
class Rozgrywka
{
  ...
  bool czy_ruch_juz_taki_byl(); // funkcja czy ruch juz taki był, jesli tak to
                                // okreslony gracz musi powtórzyc ruch
...
public:
  ...
  Rozgrywka(Pole_do_gry& P, Wynik& W, Komputer& K,
            int wyb); // Rozgrywka przyjmuje wszystkie klasy.
};
